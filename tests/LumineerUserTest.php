...
class LumineerUserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $permMock = m::mock('Peaches\Lumineer\Permission');
    ...
    {
        $roleMock = m::mock('Peaches\Lumineer\Role');
...
class HasRoleUser extends Model implements LumineerUserInterface
{
    use LumineerUserTrait;
